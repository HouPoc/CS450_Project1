...
//	This is OpenGL / GLUT program #2
//
//	The objective is to draw a polygon helicopter 
//  with animated blades  
//
...
const char *WINDOWTITLE = { "OpenGL / GLUT Project 2 -- Wenbo Hou" };
